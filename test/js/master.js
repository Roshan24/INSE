...
function loadNavBar() {
    ...
    nav.innerHTML = '<a href="index.html" class="active">Home</a><a href="about-us.html">About Us</a><div class="dropdown"><a href="#">Teams</a><div class="dropdown-content"><br><a href="teamJoin.html">Join a Team</a><a href="teamCreate.html">Create a Team</a></div></div><a href="league.html">Leagues</a></div><span id="nav-login"><i class="material-icons" id="account">account_circle</i><a href="login.html" id="login">Login</a> or <a href="login.html" id="signup">Sign up</a></span>';
